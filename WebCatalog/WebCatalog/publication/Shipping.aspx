...
<%@ Page Title="" Language="C#" MasterPageFile="~/master/webcatalog.master" AutoEventWireup="true" CodeFile="Shipping.aspx.cs" Inherits="publication_Shipping" %>
...
<div id="dViewCart" runat="server"  class="module-summary  float-right margin-bottom-none margin-top-none">
    ...
    <div class="span-4 margin-bottom-none row-end">
        <asp:Label ID="txtCountry" runat="server" Text="Canada"></asp:Label>
    </div>
