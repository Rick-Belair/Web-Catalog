...
public partial class publication_search : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        BreadCrumb1.TailName = oLang.GetLabel("Search2");
        ...
        if (Session["search"] != null)
            searchValues = (Dictionary<string, string>)Session["search"];
    ...
    private void PopulateFields()
    {
        ...
        lblTitle.InnerText = oLang.GetLabel("Search");
        lblInfo.InnerText = oLang.GetLabel("AdvSearchInfoMsg");
        lblSearchText.Text = oLang.GetLabel("KeywordSearchInfo");
        ...
        if (Session["search"] != null)
        {
            txtSearchText.Text = searchValues["SearchField"].ToString();
            ddlCategory.SelectedValue = searchValues["Category"].ToString();
            ddlDisplay.SelectedValue = searchValues["PubLang"].ToString();
            ddlSort.SelectedValue = searchValues["Sort"].ToString();
            FillDataGrid();
        }
        else
