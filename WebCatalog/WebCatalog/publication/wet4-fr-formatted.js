...
wet.builder.top = function (a, h) {
    ...
    if (null != a.lngLinks) {
        for (var b = b + ('<section id="wb-lng" class="' + (!1 != a.siteMenu ? "visible-md visible-lg " : "") + 'text-right"><h2 class="wb-inv">S\u00e9lection de la langue</h2><div class="row"><div class="col-md-12"><ul class="list-inline margin-bottom-none">'), e = a.lngLinks, f = e.length, c = 0; c < f; c++) var d = e[c],
    ...
    b += '<div class="row"><div class="brand col-xs-8 col-sm-9 col-md-6">' +
        (!1 != a.siteMenu ? '<a href="https://www.canada.ca/fr.html">' : "") + '<object type="image/svg+xml" tabindex="-1" data=\'' + wet.builder.environment(a) + 'assets/sig-blk-fr.svg\'></object><span class="wb-inv"> Gouvernement du Canada / <span lang="en">Government of Canada</span></span>' + (!1 != a.siteMenu ? "</a>" : "") + '</div><section class="wb-mb-links col-xs-4 col-sm-3 ' + (!1 != a.siteMenu ? "visible-sm visible-xs" : "") + (!1 == a.siteMenu ? " hide" : "") + '" id="wb-glb-mn"><h2>Recherche et menus</h2><ul class="list-inline text-right chvrn"><li><a href="#mb-pnl" title="Recherche et menus" aria-controls="mb-pnl" class="overlay-lnk" role="button"><span class="glyphicon glyphicon-search"><span class="glyphicon glyphicon-th-list"><span class="wb-inv">Recherche et menus</span></span></span></a></li></ul><div id="mb-pnl"></div></section>' +
    ...
    if (!1 != a.breadcrumbs) {
        ...
        if (null != a.breadcrumbs)
            for (e = a.breadcrumbs, f = e.length, c = 0; c < f; c++) d = e[c], b += "<li>" + (null != d.acronym ? '<abbr title="' + soy.$$escapeHtml(d.acronym) + '">' : "") + (null != d.href ? '<a href="' + soy.$$escapeHtml(d.href) + '">' : "") + soy.$$escapeHtml(d.title) + (null != d.href ?
                "</a>" : "") + (null != d.acronym ? "</acronym>" : "") + "</li>";
        else b += '<li><a href="https://www.canada.ca/fr.html">Accueil</a></li>';
        b += "</ol></div></div></nav>"
    }
    return b + "</header>"
};
wet.builder.preFooter = function (a, h) {
    a = a || {};
    var b = '\t\t\t<div class="row pagedetails">' + (null != a.showFeedback ? !1 != a.showFeedback ? '<div class="col-sm-6 col-lg-4 mrgn-tp-sm"><a href="' + soy.$$escapeHtml(a.showFeedback) + '" class="btn btn-default btn-block">Signaler un probl\u00e8me ou une erreur sur cette page</a></div>' : "" : '<div class="col-sm-6 col-lg-4 mrgn-tp-sm"><a href="https://www.canada.ca/fr/signaler-probleme.html" class="btn btn-default btn-block">Signaler un probl\u00e8me ou une erreur sur cette page</a></div>');
    if (!1 !=
        a.showShare) {
    ...
    return b += '<div class="datemod col-xs-12 mrgn-tp-lg"><dl id="wb-dtmd">' + (null != a.screenIdentifier ?
...
wet.builder.secmenu = function (a, h) {
    for (var b = '\t\t\t<h2 id="wb-sec-h" class="wb-inv">Menu de la section</h2>', e = a.sections, f = e.length, c = 0; c < f; c++) {
        for (var d = e[c], b = b + ('<section class="list-group menu list-unstyled"><h3>' + (null != d.sectionLink ? '<a href="' + soy.$$escapeHtml(d.sectionLink) + '"' + (!0 == d.newWindow ? ' target="_blank"' : "") + ">" : "") + soy.$$escapeHtml(d.sectionName) + (!0 == d.newWindow ? '<span class="wb-inv"> Ce lien ouvrira dans une nouvelle fen\u00eatre</span>' : "") + (null != d.sectionLink ? "</a>" : "") + '</h3><ul class="list-group menu list-unstyled">'),
            ...
            var g = d[k];
            if (null != g.subLinks) {
                for (var b = b + ('<li><a href="' + soy.$$escapeHtml(g.href) + '" class="list-group-item"' + (!0 == g.newWindow ? ' target="_blank"' : "") + ">" + soy.$$escapeHtml(g.text) + (!0 == g.newWindow ? '<span class="wb-inv"> Ce lien ouvrira dans une nouvelle fen\u00eatre</span>' : "") + '</a><ul class="list-group menu list-unstyled">'), g = g.subLinks, p = g.length, n = 0; n < p; n++) var m = g[n],
                    b = b + ('<li><a href="' + soy.$$escapeHtml(m.subhref) + '" class="list-group-item"' + (!0 == m.newWindow ?
...
wet.builder.footer = function (a, h) {
    a = a || {};
    var b = "\t\t" + (!1 != a.showFeatures ? '<aside class="gc-nttvs container"><h2>Activit\u00e9s et initiatives du gouvernement du Canada</h2><div id="gcwb_prts" class="wb-eqht row" data-wb-ajax=\'{"url": "https://cdn.canada.ca/gcweb-cdn-live/features/features-fr.html", "type": "replace", "nocache": true }\'><p class="mrgn-lft-md"><a href="https://www.canada.ca/activites.html">Acc\u00e9dez aux activit\u00e9s et initiatives du gouvernement du Canada</a></p></div></aside>' :
    ...
    if (!1 != a.showFooter) {
        ...
        if (null != a.contactLinks)
            for (var e = a.contactLinks, f = e.length, c = 0; c < f; c++) var d = e[c],
                b = b + (0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '">Contactez-nous</a></li>' : "");
        else b += '<li><a href="https://www.canada.ca/fr/contact.html">Contactez-nous</a></li>';
        ...
        if (null != a.contactLinks)
            for (e = a.contactLinks, f = e.length, c = 0; c < f; c++) d = e[c], b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '">Coordonn\u00e9es</a></li>' : "";
        else b += '<li><a href="https://www.canada.ca/fr/contact.html">Coordonn\u00e9es</a></li>';
    ...
    return b += '</ul></nav><div class="col-xs-6 visible-sm visible-xs tofpg"><a href="#wb-cont">Haut de la page <span class="glyphicon glyphicon-chevron-up"></span></a></div><div class="col-xs-6 col-md-2 text-right"><object type="image/svg+xml" tabindex="-1" role="img" data=\'' +
        wet.builder.environment(a) + 'assets/wmms-blk.svg\' aria-label="Symbole du gouvernement du Canada"></object></div></div></div></div></footer>'
};
...
serverPage.serverRefTop = function (a, h) {
    ...
    return "\t\t\x3c!--[if gte IE 9 | !IE ]>\x3c!--\x3e<link href='" + wet.builder.environment(a) + 'assets/favicon.ico\' rel="icon" type="image/x-icon"><link rel="stylesheet" href=\'' + wet.builder.environment(a) + "css/theme-srv.min.css'><link rel=\"stylesheet\" href='" + wet.builder.environment(a) + "cdts/cdtsfixes.css'>\x3c!--<![endif]--\x3e\x3c!--[if lt IE 9]><link href='" + wet.builder.environment(a) + 'assets/favicon.ico\' rel="shortcut icon" /><link rel="stylesheet" href=\'' + wet.builder.environment(a) +
        "css/ie8-theme-srv.min.css' /><script src=\"" + ("external" == a.jqueryEnv ? "https://ajax.googleapis.com/ajax/libs" : wet.builder.environment(a) + "js/") + 'jquery/1.11.1/jquery.min.js" integrity="sha256-VAvG3sHdS5LqTT+5A/aeq/bZGa/Uj04xKxY8KM/w9EE= sha384-UM1JrZIpBwVf5jj9dTKVvGiiZPZTLVoq4sfdvIe9SBumsvCuv6AHDNtEiIb5h1kU sha512-nhY06wKras39lb9lRO76J4397CH1XpRSLfLJSftTeo3+q2vP7PaebILH9TqH+GRpnOhfAGjuYMVmVTOZJ+682w==" crossorigin="anonymous">\x3c/script><script src=\'' + wet.builder.environment(a) + "js/ie8-wet-boew.min.js'>\x3c/script><![endif]--\x3e"
};
serverPage.serverTop = function (a, h) {
    return '\t\t<header role="banner" id="wb-bnr" class="container"><div class="row"><div class="col-sm-6"><object id="gcwu-sig" type="image/svg+xml" tabindex="-1" role="img" data=\'' + wet.builder.environment(a) + 'assets/sig-blk-fr.svg\' aria-label="Gouvernement du Canada / Government of Canada"></object></div><div class="col-sm-6"><object id="wmms" type="image/svg+xml" tabindex="-1" role="img" data=\'' + wet.builder.environment(a) + 'assets/wmms-blk.svg\' aria-label="Symbole du gouvernement du Canada"></object></div></div></header>'
};
...
applicationPage.appTop = function (a, h) {
    var b = '\t\t<ul id="wb-tphp"><li class="wb-slc"><a class="wb-sl" href="#wb-cont">Passer au contenu principal</a></li><li class="wb-slc visible-sm visible-md visible-lg"><a class="wb-sl" href="#wb-info">Passer \u00e0 \u00ab&#160;' + (!0 == a.topCusMenu ? "Liens connexes" : "\u00c0 propos de cette application Web") + "&#160;\u00bb</a></li>" + (!0 == a.topSecMenu ? '<li class="wb-slc visible-md visible-lg"><a class="wb-sl" href="#wb-sec">Passer au menu de la section</a></li>' : "") +
        '</ul><header role="banner"><div id="wb-bnr" class="container"><div class="row"><div class="brand col-xs-9 col-sm-8 col-md-6"><object type="image/svg+xml" tabindex="-1" data=\'' + wet.builder.environment(a) + 'assets/sig-blk-fr.svg\'></object><span class="wb-inv"> Gouvernement du Canada / <span lang="en">Government of Canada</span></span></div>';
    if (null != a.lngLinks) {
        for (var b = b + '<section id="wb-lng" class="text-right col-xs-3 col-sm-4 col-md-6"><h2 class="wb-inv">S\u00e9lection de la langue</h2><ul class="list-inline margin-bottom-none">',
                e = a.lngLinks, f = e.length, c = 0; c < f; c++) var d = e[c],
            b = b + ('<li><a lang="' + soy.$$escapeHtml(d.lang) + '" href="' + soy.$$escapeHtml(d.href) + '">' + soy.$$escapeHtml(d.text) + "</a></li>");
        b += "</ul></section>"
    }
    ...
    if (null != a.appSettings || null != a.signOut || null != a.signIn) {
        ...
        if (null != a.appSettings)
            for (e = a.appSettings, f = e.length, c = 0; c < f; c++) d = e[c], b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '" class="btn"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Param\u00e8tres du compte</a></li>&#32;' : "";
        if (null != a.signOut)
            for (e = a.signOut, f = e.length, c = 0; c < f; c++) d = e[c], b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '" class="btn"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Fermer la session</a></li>' : "";
    ...
    if (null != a.customSearch || null != a.menuPath || null != a.menuLinks || !0 == a.topSecMenu || null != a.appSettings || null != a.signOut || null != a.signIn) {
        ...
        if (null != a.appSettings || null != a.signOut || null != a.signIn) {
            ...
            if (null != a.signOut)
                for (e = a.signOut,
                    f = e.length, c = 0; c < f; c++) d = e[c], b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '" class="btn"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Fermer la session</a></li>' : "";
            else if (null != a.signIn)
                for (e = a.signIn, f = e.length, c = 0; c < f; c++) d = e[c], b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '" class="btn"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Ouvrir une session</a></li>' : "";
            b += "</ul></nav>"
        }
        b += "</div>";
        if (null != a.menuLinks) {
            ...
            for (c = 0; c < f; c++)
                if (d = e[c], null != d.subLinks) {
                    for (var b = b + ("<li><a" + (null != d.href ? ' href="' + soy.$$escapeHtml(d.href) + '"' : "") + ' class="item"' + (!0 == d.newWindow ? ' target="_blank"' : "") + ">" + soy.$$escapeHtml(d.text) + (!0 == d.newWindow ? '<span class="wb-inv"> Ce lien ouvrira dans une nouvelle fen\u00eatre</span>' : "") + '</a><ul class="sm list-unstyled" id="s2" role="menu">'), d = d.subLinks, l = d.length, k = 0; k < l; k++) var g = d[k],
                        b = b + (k == l - 1 ? '<li class="slflnk"><a href="' + soy.$$escapeHtml(g.subhref) +
...
applicationPage.appFooter = function (a, h) {
    a = a || {};
    var b = "\t\t" + (!0 == a.showFeatures ? '<aside class="gc-nttvs container"><h2>Activit\u00e9s et initiatives du gouvernement du Canada</h2><div id="gcwb_prts" class="wb-eqht row" data-wb-ajax=\'{"url": "https://cdn.canada.ca/gcweb-cdn-live/features/features-fr.html", "type": "replace", "nocache": true }\'><p class="mrgn-lft-md"><a href="https://www.canada.ca/activites.html">Acc\u00e9dez aux activit\u00e9s et initiatives du gouvernement du Canada</a></p></div></aside>' : "") +
        '<footer role="contentinfo" id="wb-info">';
    if (null != a.footerSections) {
        for (var b = b + '<nav role="navigation" class="container wb-navcurr"><h2 class="wb-inv">Liens connexes</h2><ul class="list-unstyled colcount-sm-2 colcount-md-3">', e = a.footerSections, f = e.length, c = 0; c < f; c++) var d = e[c],
            b = b + ('<li><a href="' + soy.$$escapeHtml(d.href) + '"' + (!0 == d.newWindow ? ' target="_blank"' : "") + ">" + soy.$$escapeHtml(d.text) + (!0 == d.newWindow ? '<span class="wb-inv"> Ce lien ouvrira dans une nouvelle fen\u00eatre</span>' : "") + "</a></li>");
        b += "</ul></nav>"
    }
