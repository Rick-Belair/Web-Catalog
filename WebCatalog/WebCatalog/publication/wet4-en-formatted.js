...
wet.builder.environment = function (a, h) {
    return ("esdcqat" == a.cdnEnv ? "https://cdn-canada.services.gc.qat/app/cls/WET" : "esdcnonprod" == a.cdnEnv ? "https://s2tst-cdn-canada.sade-edap.prv/app/cls/WET" : "esdcprod" == a.cdnEnv ? "https://ssl-templates.services.gc.ca/app/cls/WET" : "https://www.canada.ca/etc/designs/canada/cdts") + "/gcweb/v4_0_26/"
};
wet.builder.refTop = function (a, h) {
    ...
    return "\t\t\x3c!--[if gte IE 9 | !IE ]>\x3c!--\x3e<link href='" + wet.builder.environment(a) + 'assets/favicon.ico\' rel="icon" type="image/x-icon"><link rel="stylesheet" href=\'' + wet.builder.environment(a) + "css/theme.min.css'><link rel=\"stylesheet\" href='" + wet.builder.environment(a) + "cdts/cdtsfixes.css'>" + (!0 == a.isApplication ? '<link rel="stylesheet" href=\'' + wet.builder.environment(a) + "cdts/cdtsapps.css'>" : "") + "\x3c!--<![endif]--\x3e\x3c!--[if lt IE 9]><link href='" +
        wet.builder.environment(a) + 'assets/favicon.ico\' rel="shortcut icon" /><link rel="stylesheet" href=\'' + wet.builder.environment(a) + "css/ie8-theme.min.css' /><script src=\"" + ("external" == a.jqueryEnv ? "https://ajax.googleapis.com/ajax/libs" : wet.builder.environment(a) + "js/") + 'jquery/1.11.1/jquery.min.js" integrity="sha256-VAvG3sHdS5LqTT+5A/aeq/bZGa/Uj04xKxY8KM/w9EE= sha384-UM1JrZIpBwVf5jj9dTKVvGiiZPZTLVoq4sfdvIe9SBumsvCuv6AHDNtEiIb5h1kU sha512-nhY06wKras39lb9lRO76J4397CH1XpRSLfLJSftTeo3+q2vP7PaebILH9TqH+GRpnOhfAGjuYMVmVTOZJ+682w==" crossorigin="anonymous">\x3c/script><script src=\'' +
...
wet.builder.top = function (a, h) {
    ...
    if (null != a.lngLinks) {
        for (var b = b + ('<section id="wb-lng" class="' +
                (!1 != a.siteMenu ? "visible-md visible-lg " : "") + 'text-right"><h2 class="wb-inv">Language selection</h2><div class="row"><div class="col-md-12"><ul class="list-inline margin-bottom-none">'), e = a.lngLinks, f = e.length, c = 0; c < f; c++) var d = e[c],
            b = b + ('<li><a lang="' + soy.$$escapeHtml(d.lang) + '" href="' + soy.$$escapeHtml(d.href) + '">' + soy.$$escapeHtml(d.text) + "</a></li>");
    ...
    b += '<div class="row"><div class="brand col-xs-8 col-sm-9 col-md-6">' + (!1 != a.siteMenu ? '<a href="https://www.canada.ca/en.html">' :
        ...
        (!1 != a.search ? '<section id="wb-srch" class="col-xs-6 text-right visible-md visible-lg"><h2>Search</h2><form action="https://www.canada.ca/en/sr.html" method="get" name="cse-search-box" role="search" class="form-inline"><div class="form-group"><label for="wb-srch-q" class="wb-inv">Search website</label><input name="cdn" value="canada" type="hidden"><input name="st" value="s" type="hidden"><input name="num" value="10" type="hidden"><input name="langs" value="en" type="hidden"><input name="st1rt" value="1" type="hidden"><input name="s5bm3ts21rch" value="x" type="hidden"><input id="wb-srch-q" list="wb-srch-q-ac" class="wb-srch-q form-control" name="q" type="search" value="" size="27" maxlength="150" placeholder="Search Canada.ca"><input type="hidden" name="_charset_" value="UTF-8"><datalist id="wb-srch-q-ac">\x3c!--[if lte IE 9]><select><![endif]--\x3e\x3c!--[if lte IE 9]></select><![endif]--\x3e</datalist></div><div class="form-group submit"><button type="submit" id="wb-srch-sub" class="btn btn-primary btn-small" name="wb-srch-sub"><span class="glyphicon-search glyphicon"></span><span class="wb-inv">Search</span></button></div></form></section>' :
            "") + "</div></div>" + (!1 != a.siteMenu ? '<nav role="navigation" id="wb-sm" data-wb-ajax=\'{"url": "https://cdn.canada.ca/gcweb-cdn-live/sitemenu/sitemenu-en.html", "type": "replace", "nocache": true }\' data-trgt="mb-pnl" class="wb-menu visible-md visible-lg" typeof="SiteNavigationElement"><div class="container nvbar"><h2>Topics menu</h2><div class="row"><ul class="list-inline menu"><li><a href="https://www.canada.ca/en/services/jobs.html">Jobs</a></li><li><a href="http://www.cic.gc.ca/english/index.asp">Immigration</a></li><li><a href="https://travel.gc.ca/">Travel</a></li><li><a href="https://www.canada.ca/en/services/business.html">Business</a></li><li><a href="https://www.canada.ca/en/services/benefits.html">Benefits</a></li><li><a href="https://www.canada.ca/en/services/health.html">Health</a></li><li><a href="https://www.canada.ca/en/services/taxes.html">Taxes</a></li><li><a href="https://www.canada.ca/en/services.html">More services</a></li></ul></div></div></nav>' :
    ...
    if (!1 != a.breadcrumbs) {
        ...
        if (null != a.breadcrumbs)
            for (e = a.breadcrumbs, f = e.length, c = 0; c < f; c++) d = e[c], b += "<li>" + (null != d.acronym ? '<abbr title="' + soy.$$escapeHtml(d.acronym) + '">' : "") + (null != d.href ? '<a href="' + soy.$$escapeHtml(d.href) + '">' : "") + soy.$$escapeHtml(d.title) + (null != d.href ? "</a>" :
                "") + (null != d.acronym ? "</abbr>" : "") + "</li>";
        else b += '<li><a href="https://www.canada.ca/en.html">Home</a></li>';
        b += "</ol></div></div></nav>"
    }
    return b + "</header>"
};
wet.builder.preFooter = function (a, h) {
    a = a || {};
    var b = '\t\t\t<div class="row pagedetails">' + (null != a.showFeedback ? !1 != a.showFeedback ? '<div class="col-sm-6 col-lg-4 mrgn-tp-sm"><a href="' + soy.$$escapeHtml(a.showFeedback) + '" class="btn btn-default btn-block">Report a problem or mistake on this page</a></div>' : "" : '<div class="col-sm-6 col-lg-4 mrgn-tp-sm"><a href="https://www.canada.ca/en/report-problem.html" class="btn btn-default btn-block">Report a problem or mistake on this page</a></div>');
    if (!1 != a.showShare) {
        b +=
    ...
    return b += '<div class="datemod col-xs-12 mrgn-tp-lg"><dl id="wb-dtmd">' + (null != a.screenIdentifier ? '<dt>Screen Identifier:&#32;</dt><dd property="identifier">' +
...
wet.builder.secmenu = function (a, h) {
    for (var b = '\t\t\t<h2 id="wb-sec-h" class="wb-inv">Section menu</h2>', e = a.sections, f = e.length, c = 0; c < f; c++) {
        for (var d = e[c], b = b + ('<section class="list-group menu list-unstyled"><h3>' + (null != d.sectionLink ? '<a href="' + soy.$$escapeHtml(d.sectionLink) + '"' + (!0 == d.newWindow ? ' target="_blank"' : "") + ">" : "") + soy.$$escapeHtml(d.sectionName) + (!0 == d.newWindow ? '<span class="wb-inv"> This link will open in a new window</span>' : "") + (null != d.sectionLink ? "</a>" : "") + '</h3><ul class="list-group menu list-unstyled">'),
            ...
            var g = d[k];
            if (null != g.subLinks) {
                for (var b = b + ('<li><a href="' + soy.$$escapeHtml(g.href) + '" class="list-group-item"' + (!0 == g.newWindow ? ' target="_blank"' : "") + ">" + soy.$$escapeHtml(g.text) + (!0 == g.newWindow ? '<span class="wb-inv"> This link will open in a new window</span>' : "") + '</a><ul class="list-group menu list-unstyled">'), g = g.subLinks, p = g.length, n = 0; n < p; n++) var m = g[n],
                    b = b + ('<li><a href="' + soy.$$escapeHtml(m.subhref) + '" class="list-group-item"' + (!0 == m.newWindow ? ' target="_blank"' :
...
wet.builder.footer = function (a, h) {
    a = a || {};
    var b = "\t\t" + (!1 != a.showFeatures ? '<aside class="gc-nttvs container"><h2>Government of Canada activities and initiatives</h2><div id="gcwb_prts" class="wb-eqht row" data-wb-ajax=\'{"url": "https://cdn.canada.ca/gcweb-cdn-live/features/features-en.html", "type": "replace", "nocache": true }\'><p class="mrgn-lft-md"><a href="https://www.canada.ca/activities.html">Access Government of Canada activities and initiatives</a></p></div></aside>' : "") + '<footer role="contentinfo" id="wb-info">';
    if (!1 != a.showFooter) {
        ...
        if (null != a.contactLinks)
            for (var e = a.contactLinks, f = e.length, c = 0; c < f; c++) var d = e[c],
                b = b + (0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '">Contact us</a></li>' : "");
        else b += '<li><a href="https://www.canada.ca/en/contact.html">Contact us</a></li>';
        b += '<li><a href="https://www.canada.ca/en/government/dept.html">Departments and agencies</a></li><li><a href="https://www.canada.ca/en/government/publicservice.html">Public service and military</a></li><li><a href="http://www.servicecanada.gc.ca/gcnews">News</a></li><li><a href="https://www.canada.ca/en/government/system/laws.html">Treaties, laws and regulations</a></li><li><a href="https://www.canada.ca/en/transparency/reporting.html">Government-wide reporting</a></li><li><a href="http://pm.gc.ca/eng">Prime Minister</a></li><li><a href="https://www.canada.ca/en/government/system.html">How government works</a></li><li><a href="http://open.canada.ca/en/">Open government</a></li></ul></nav><div class="brand"><div class="container"><div class="row"><nav class="col-md-10 ftr-urlt-lnk"><h2 class="wb-inv">About this site</h2><ul><li><a href="https://www.canada.ca/en/social.html">Social media</a></li><li><a href="https://www.canada.ca/en/mobile.html">Mobile applications</a></li><li><a href="https://www1.canada.ca/en/newsite.html">About Canada.ca</a></li><li><a href="https://www.canada.ca/en/transparency/terms.html">Terms and conditions</a></li><li><a href="https://www.canada.ca/en/transparency/privacy.html">Privacy</a></li>'
    } else {
        b +=
        ...
        if (null != a.contactLinks)
            for (e = a.contactLinks, f = e.length, c = 0; c < f; c++) d = e[c], b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '">Contact information</a></li>' : "";
        else b += '<li><a href="https://www.canada.ca/en/contact.html">Contact information</a></li>';
...
wet.builder.refFooter = function (a, h) {
    a = a || {};
    return "\t\t\x3c!--[if gte IE 9 | !IE ]>\x3c!--\x3e<script src='" + ("external" == a.jqueryEnv ? "https://ajax.googleapis.com/ajax/libs/" : wet.builder.environment(a) + "js/") + 'jquery/2.1.4/jquery.min.js\' integrity="sha256-ImQvICV38LovIsvla2zykaCTdEh1Z801Y+DSop91wMU= sha384-8gBf6Y4YYq7Jx97PIqmTwLPin4hxIzQw5aDmUg/DDhul9fFpbbLcLh3nTIIDJKhx sha512-AFwxAkWdvxRd9qhYYp1qbeRZj6/iTNmJ2GFwcxsMOzwwTaRwz2a/2TX225Ebcj3whXte1WGQb38cXE5j7ZQw3g==" crossorigin="anonymous">\x3c/script><script src=\'' + wet.builder.environment(a) +
...
wet.builder.splash = function (a, h) {
    return '\t\t<div id="bg"><img src=\'' + wet.builder.environment(a) + 'img/splash/sp-bg-2.jpg\' alt=""></div><main role="main"><div class="sp-hb"><div class="sp-bx col-xs-12"><h1 property="name" class="wb-inv">Canada.ca</h1><div class="row"><div class="col-xs-11 col-md-8"><object type="image/svg+xml" tabindex="-1" role="img" data=\'' + wet.builder.environment(a) + 'assets/sig-spl.svg\' width="283" aria-label="Government of Canada / Gouvernement du Canada"></object></div></div><div class="row"><section class="col-xs-6 text-right">' +
        ...
        ("external" == a.jqueryEnv ? "https://ajax.googleapis.com/ajax/libs" : wet.builder.environment(a) + "js/") + 'jquery/2.1.4/jquery.min.js" integrity="sha256-ImQvICV38LovIsvla2zykaCTdEh1Z801Y+DSop91wMU= sha384-8gBf6Y4YYq7Jx97PIqmTwLPin4hxIzQw5aDmUg/DDhul9fFpbbLcLh3nTIIDJKhx sha512-AFwxAkWdvxRd9qhYYp1qbeRZj6/iTNmJ2GFwcxsMOzwwTaRwz2a/2TX225Ebcj3whXte1WGQb38cXE5j7ZQw3g==" crossorigin="anonymous">\x3c/script><script src=\'' + wet.builder.environment(a) + "js/wet-boew.min.js'>\x3c/script>\x3c!--<![endif]--\x3e\x3c!--[if lt IE 9]><script src='" +
        wet.builder.environment(a) + "js/ie8-wet-boew2.min.js'>\x3c/script><![endif]--\x3e<script src='" + wet.builder.environment(a) + "js/theme.min.js'>\x3c/script>" + (null != a.webAnalytics ? '<script type="text/javascript">_satellite.pageBottom();\x3c/script>' : "")
};
if ("undefined" == typeof serverPage) var serverPage = {};
serverPage.serverRefTop = function (a, h) {
    a = a || {};
    return "\t\t\x3c!--[if gte IE 9 | !IE ]>\x3c!--\x3e<link href='" + wet.builder.environment(a) + 'assets/favicon.ico\' rel="icon" type="image/x-icon"><link rel="stylesheet" href=\'' + wet.builder.environment(a) + "css/theme-srv.min.css'><link rel=\"stylesheet\" href='" + wet.builder.environment(a) + "cdts/cdtsfixes.css'>\x3c!--<![endif]--\x3e\x3c!--[if lt IE 9]><link href='" + wet.builder.environment(a) + 'assets/favicon.ico\' rel="shortcut icon" /><link rel="stylesheet" href=\'' +
        wet.builder.environment(a) + "css/ie8-theme-srv.min.css' /><script src=\"" + ("external" == a.jqueryEnv ? "https://ajax.googleapis.com/ajax/libs" : wet.builder.environment(a) + "js/") + 'jquery/1.11.1/jquery.min.js" integrity="sha256-VAvG3sHdS5LqTT+5A/aeq/bZGa/Uj04xKxY8KM/w9EE= sha384-UM1JrZIpBwVf5jj9dTKVvGiiZPZTLVoq4sfdvIe9SBumsvCuv6AHDNtEiIb5h1kU sha512-nhY06wKras39lb9lRO76J4397CH1XpRSLfLJSftTeo3+q2vP7PaebILH9TqH+GRpnOhfAGjuYMVmVTOZJ+682w==" crossorigin="anonymous">\x3c/script><script src=\'' + wet.builder.environment(a) +
        "js/ie8-wet-boew.min.js'>\x3c/script><![endif]--\x3e"
};
serverPage.serverTop = function (a, h) {
    return '\t\t<header role="banner" id="wb-bnr" class="container"><div class="row"><div class="col-sm-6"><object id="gcwu-sig" type="image/svg+xml" tabindex="-1" role="img" data=\'' + wet.builder.environment(a) + 'assets/sig-blk-en.svg\' aria-label="Government of Canada / Gouvernement du Canada"></object></div><div class="col-sm-6"><object id="wmms" type="image/svg+xml" tabindex="-1" role="img" data=\'' + wet.builder.environment(a) + 'assets/wmms-blk.svg\' aria-label="Symbol of the Government of Canada"></object></div></div></header>'
};
...
applicationPage.appTop = function (a, h) {
    var b = '\t\t<ul id="wb-tphp"><li class="wb-slc"><a class="wb-sl" href="#wb-cont">Skip to main content</a></li><li class="wb-slc visible-sm visible-md visible-lg"><a class="wb-sl" href="#wb-info">Skip to "' + (!0 == a.topCusMenu ? "Related links" : "About this Web application") + '"</a></li>' + (!0 == a.topSecMenu ? '<li class="wb-slc visible-md visible-lg"><a class="wb-sl" href="#wb-sec">Skip to section menu</a></li>' : "") + '</ul><header role="banner"><div id="wb-bnr" class="container"><div class="row"><div class="brand col-xs-9 col-sm-8 col-md-6"><object type="image/svg+xml" tabindex="-1" data=\'' +
        wet.builder.environment(a) + 'assets/sig-blk-en.svg\'></object><span class="wb-inv"> Government of Canada / <span lang="fr">Gouvernement du Canada</span></span></div>';
    if (null != a.lngLinks) {
        for (var b = b + '<section id="wb-lng" class="text-right col-xs-3 col-sm-4 col-md-6"><h2 class="wb-inv">Language selection</h2><ul class="list-inline margin-bottom-none">', e = a.lngLinks, f = e.length, c = 0; c < f; c++) var d = e[c],
            b = b + ('<li><a lang="' + soy.$$escapeHtml(d.lang) + '" href="' + soy.$$escapeHtml(d.href) + '">' + soy.$$escapeHtml(d.text) +
                "</a></li>");
        b += "</ul></section>"
    }
    ...
    if (null != a.appSettings || null != a.signOut || null != a.signIn) {
        ...
        if (null != a.appSettings)
            for (e = a.appSettings, f = e.length, c = 0; c < f; c++) d = e[c], b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '" class="btn"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Account settings</a></li>&#32;' : "";
        if (null != a.signOut)
            for (e = a.signOut, f = e.length, c = 0; c < f; c++) d = e[c], b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '" class="btn"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Sign out</a></li>' : "";
        else if (null != a.signIn)
            for (e = a.signIn, f = e.length,
    ...
    if (null != a.customSearch || null != a.menuPath || null != a.menuLinks || !0 == a.topSecMenu || null != a.appSettings || null != a.signOut || null != a.signIn) {
        ...
        if (null != a.appSettings || null != a.signOut || null != a.signIn) {
            ...
            if (null != a.appSettings)
                for (e = a.appSettings, f = e.length, c = 0; c < f; c++) d = e[c], b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '" class="btn"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Account settings</a></li>&#32;' : "";
            if (null != a.signOut)
                for (e = a.signOut, f = e.length, c = 0; c < f; c++) d = e[c],
                    b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '" class="btn"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Sign out</a></li>' : "";
            else if (null != a.signIn)
                for (e = a.signIn, f = e.length, c = 0; c < f; c++) d = e[c], b += 0 == c ? '<li><a href="' + soy.$$escapeHtml(d.href) + '" class="btn"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> Sign in</a></li>' : "";
            b += "</ul></nav>"
        }
        b += "</div>";
        if (null != a.menuLinks) {
            ...
            f = e.length;
            for (c = 0; c < f; c++)
                if (d = e[c], null != d.subLinks) {
                    for (var b = b + ("<li><a" + (null != d.href ? ' href="' + soy.$$escapeHtml(d.href) + '"' : "") + ' class="item"' + (!0 == d.newWindow ? ' target="_blank"' : "") + ">" + soy.$$escapeHtml(d.text) + (!0 == d.newWindow ? '<span class="wb-inv"> This link will open in a new window</span>' : "") + '</a><ul class="sm list-unstyled" id="s2" role="menu">'), d = d.subLinks, l = d.length, k = 0; k < l; k++) var g = d[k],
                        b = b + (k == l - 1 ? '<li class="slflnk"><a href="' + soy.$$escapeHtml(g.subhref) + '"' + (!0 ==
...
applicationPage.appFooter = function (a, h) {
    a = a || {};
    var b = "\t\t" + (!0 == a.showFeatures ? '<aside class="gc-nttvs container"><h2>Government of Canada activities and initiatives</h2><div id="gcwb_prts" class="wb-eqht row" data-wb-ajax=\'{"url": "https://cdn.canada.ca/gcweb-cdn-live/features/features-en.html", "type": "replace", "nocache": true }\'><p class="mrgn-lft-md"><a href="https://www.canada.ca/activities.html">Access Government of Canada activities and initiatives</a></p></div></aside>' : "") + '<footer role="contentinfo" id="wb-info">';
    if (null != a.footerSections) {
        for (var b = b + '<nav role="navigation" class="container wb-navcurr"><h2 class="wb-inv">Related links</h2><ul class="list-unstyled colcount-sm-2 colcount-md-3">', e = a.footerSections, f = e.length, c = 0; c < f; c++) var d = e[c],
            b = b + ('<li><a href="' + soy.$$escapeHtml(d.href) + '"' + (!0 == d.newWindow ? ' target="_blank"' : "") + ">" + soy.$$escapeHtml(d.text) + (!0 == d.newWindow ? '<span class="wb-inv"> This link will open in a new window</span>' : "") + "</a></li>");
        b += "</ul></nav>"
    }
    return b += '<div class="brand"><div class="container"><div class="row"><nav class="col-md-10 ftr-urlt-lnk"><h2 class="wb-inv">About this Web application</h2><ul>' +
        (null != a.contactLink ? '<li><a href="' + soy.$$escapeHtml(a.contactLink) + '">Contact information</a></li>' : '<li><a href="https://www.canada.ca/en/contact.html">Contact information</a></li>') + (null != a.termsLink ? '<li><a href="' + soy.$$escapeHtml(a.termsLink) + '">Terms and conditions</a></li>' : '<li><a href="https://www.canada.ca/en/transparency/terms.html">Terms and conditions</a></li>') + (null != a.privacyLink ? '<li><a href="' + soy.$$escapeHtml(a.privacyLink) + '">Privacy</a></li>' : '<li><a href="https://www.canada.ca/en/transparency/privacy.html">Privacy</a></li>') +
        '</ul></nav><div class="col-xs-6 visible-sm visible-xs tofpg"><a href="#wb-cont">Top of Page <span class="glyphicon glyphicon-chevron-up"></span></a></div><div class="col-xs-6 col-md-2 text-right"><object type="image/svg+xml" tabindex="-1" role="img" data=\'' + wet.builder.environment(a) + 'assets/wmms-blk.svg\' aria-label="Symbol of the Government of Canada"></object></div></div></div></div></footer>'
};
